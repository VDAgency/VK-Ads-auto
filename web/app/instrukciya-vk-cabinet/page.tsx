...
export const metadata: Metadata = {
  title: "Как создать кабинет VK Реклама — инструкция",
};
  ...
  return (
    <>
      ...
      <main className="wrap" id="ins-main">
        ...
        <h1>Как создать кабинет VK Реклама</h1>
        <p className="lead">
          Рекламный кабинет для запуска кампании заводим мы сами — от вас этого не требуется. Эта
          инструкция для тех, кто хочет завести свой кабинет самостоятельно, например чтобы иметь к
          нему прямой доступ. Шаги ниже проведут вас через регистрацию.
        </p>

        <div className="callout">
          <b>Коротко:</b> зайдите на ads.vk.ru → войдите через почту → создайте новый кабинет (тип
          «Рекламодатель», физическое или юридическое лицо, валюта — рубль). На этом регистрация
          закончена.
        </div>
        ...
        <div className="callout">
          Не получается создать кабинет? Напишите нам — поможем и подскажем.
        </div>
