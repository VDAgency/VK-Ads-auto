...
const FAQ = [
  {
    ...
    a: "Сообщество или страница ВКонтакте, которую вы продвигаете, и заполненный бриф. Рекламный кабинет VK заводить не нужно — этим занимаемся мы.",
  },
  {
    q: "Нужно ли мне самому заводить рекламный кабинет VK?",
    a: "Нет. Рекламный кабинет заводим и ведём мы — вам не нужно ничего регистрировать и настраивать. Если хотите завести кабинет самостоятельно, ниже есть пошаговая инструкция.",
  },
  {
          ...
          <div className="lp-container">
            <div className="lp-final__card reveal">
              ...
              <p className="lp-final__note">
                Хотите завести рекламный кабинет VK самостоятельно?{" "}
                <a href="/instrukciya-vk-cabinet.html">Инструкция, как это сделать</a>.
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="lp-footer">
        <div className="lp-container lp-footer__inner">
          ...
          <nav className="lp-footer__links" aria-label="Ссылки в подвале">
            ...
            <a href="/instrukciya-vk-cabinet.html">Кабинет VK: инструкция</a>
