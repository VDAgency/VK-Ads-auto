...
export const BRIEF_SURFACES: BriefSurfaceOption[] = [
  ...
  // Пакет VK (3127) найден только по документации, боевой проверки не было —
  // остаётся заблокированной, пока integrations/vk_surfaces.VK_MESSAGES не станет
  // verified=True (docs/VK_API_REFERENCE.md, «Как проверить площадку «Сообщения»»).
  { value: "написать сообщение", label: "✉️ Сообщения сообществу ВКонтакте", enabled: false },
];
